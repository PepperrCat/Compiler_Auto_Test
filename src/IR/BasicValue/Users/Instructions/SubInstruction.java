...
public class SubInstruction extends BinaryInstruction{
    public SubInstruction(String name, BasicBlock parent, Value left, Value right) {
        super(name, parent, new IntType(32), left, right);
    }

    public String toString() {
        return getValueName() + " = sub " + getValueType() + " " + getValue(0).getValueName() + ", " + getValue(1).getValueName();
    }
}
